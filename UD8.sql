...
DELIMITER //
CREATE PROCEDURE borra_datos_por_superficie(IN min_superficie FLOAT, IN max_superficie FLOAT)

BEGIN
  DELETE FROM Datos WHERE Superficie >= min_superficie AND Superficie <= max_superficie;
END; //
//	DELIMITER ;
...
#------------------------------------------------------------------------
DELIMITER //
CREATE FUNCTION superficie_media_comarca(comarca VARCHAR(30))
RETURNS FLOAT
DETERMINISTIC
BEGIN
...
#------------------------------------------------------------------------
DELIMITER //
CREATE TRIGGER TuplaBorrada_to_Datos_Borrados
...
#------------------------------------------------------------------------
DELIMITER //
Drop procedure if exists reset_deleted_values//
CREATE PROCEDURE reset_deleted_values()
begin
insert into Datos
select * 
from Datos_Borrados;
...
#------------------------------------------------------------------------
DELIMITER //
		DROP PROCEDURE IF EXISTS delete_Datos_Borrados //
        CREATE PROCEDURE delete_Datos_Borrados() 
			BEGIN
